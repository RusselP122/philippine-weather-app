...
if __name__ == "__main__":
    ...
    title_5day = f"{days_5day_str}-Day Forecast Tropical Cyclone Tracks - ECMWF AIFS ({forecast_start} to {end_5day})"
    ...
    title_15day = f"{days_15day_str}-Day Forecast Tropical Cyclone Tracks - ECMWF AIFS ({forecast_start} to {end_15day})"
