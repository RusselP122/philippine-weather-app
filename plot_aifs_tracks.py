...
if __name__ == "__main__":
    ...
    title_5day = f"ECMWF AIFS {days_5day_str}-Day Forecast Tropical Cyclone Tracks\nWestern Pacific ({forecast_start} to {end_5day})"
    ...
    title_15day = f"ECMWF AIFS {days_15day_str}-Day Forecast Tropical Cyclone Tracks\nWestern Pacific ({forecast_start} to {end_15day})"
