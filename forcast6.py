...
if len(lons) < 2:
    ...
    ax.text(0.01, 0.01, disclaimer, transform=ax.transAxes, fontsize=8, ha='left', va='bottom', weight='bold', color='#FFD700', bbox=dict(facecolor='#111111', alpha=0.85, edgecolor='none', boxstyle='round,pad=0.5'))

    # Add title
    ax.set_title("Week 2 Tropical Weather Outlook - Western Pacific", fontsize=18, weight='heavy', pad=15,
