...
ax.set_title(f"FNV3 1000 Ensemble 15-Day Forecast Tropical Cyclone Tracks - Western Pacific ({start_date} to {end_date})", fontsize=16, weight='bold')
...
try:
    ...
    output_file = f"{output_dir}/fnv3_tropical_cyclone_15day_forecast_{init_time_str}.png"
